...
class simple_html_dom_node {
    ...
    function outertext() {
     ...
     // trigger callback
        ...
        if (isset($this->_[HDOM_INFO_TEXT]))
            return !empty($this->dom) ? $this->dom->restore_noise($this->_[HDOM_INFO_TEXT]) : '';
...
class simple_html_dom {
    ...
    protected $optional_closing_tags = array('tr' => array('tr' => 1, 'td' => 1, 'th' => 1), 'th' => array('th' => 1), 'td' => array('td' => 1), 'li' => array('li' => 1), 'dt' => array('dt' => 1, 'dd' => 1), 'dd' => array('dd' => 1, 'dt' => 1), 'dl' => array('dd' => 1, 'dt' => 1), 'p' => array('p' => 1), 'nobr' => array('nobr' => 1), 'b' => array('b' => 1));
